...
class BaseConfig(Config):
    ...
    def experiment_config(self):
        ...
        self.experiment.save.always_save_latest = True              # if False, only refresh last.pth on scheduled checkpoint epochs
        self.experiment.save.checkpoint_state_mode = "full"         # "full" keeps optimizer state, "policy_only" is lighter and eval-focused
