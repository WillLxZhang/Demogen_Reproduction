...
def apply_translation_to_reset_state(reset_state: dict, env_name: str, translation: np.ndarray | None) -> tuple[np.ndarray | None, np.ndarray | None]:
...
def main() -> None:
    ...
    if args.translate_object != "off":
        ...
        if translation is not None:
            applied_object_translation, applied_target_translation = apply_translation_to_reset_state(
